...
{
    public class EtichettaTelo_squadrato(Etichetta etichetta) : EtichettaDrawBase(etichetta)
    {
...
//GFX.DrawString("Telo squadrato", new Font("thaoma", 8), Brushes.Black, 210, 3);
