...
{
    public class EtichettaSole_33_41_Molla(Etichetta etichetta) : EtichettaDrawBase(etichetta)
    {
...
//GFX2.DrawString("(" + nAgganciCingoliPannelli + ")agg.Interm", new Font("thaoma", 8), Brushes.Black, 123, 54);
//GFX2.DrawString("Pacco D", new Font("thaoma", 8, FontStyle.Bold), Brushes.Black, 123, 66);
