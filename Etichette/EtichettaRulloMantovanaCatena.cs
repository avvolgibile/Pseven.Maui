...
{
    public class EtichettaRulloMantovanaCatena(Etichetta etichetta) : EtichettaDrawBase(etichetta   )
    {
...
//GFX.DrawString("R. Mantovana Cat", new Font("thaoma", 8), Brushes.Black, 210, 3);
...
//GFX.DrawString("COM " + comandiXaffiancate[0], new Font("thaoma", 8), Brushes.Black, 155, 40);
//GFX.DrawString(Hc, new Font("thaoma", 8), Brushes.Black, 205, 40);
//GFX.DrawString("(" + mixTeloFinita + ")tess " + elementivari.coestruso, new Font("thaoma", 8), Brushes.Black, 95, 58);
//GFX.DrawString(elementivari.tipoStaffa, new Font("thaoma", 7, FontStyle.Bold), Brushes.Black, 130, 71);
...
//// GFX2.DrawString("COM " + ComandiCMBX.Text, new Font("thaoma", 8), Brushes.Black, 125, 29);
...
//GFX2.DrawString("mantovana", new Font("thaoma", 7), Brushes.Black, 14, 37);
//GFX2.DrawImage(barcode.Draw(string.Format(barcodeStruct, mixTaglioProfilo.ToString("0000")), 8), 10, 52);
//GFX2.DrawString(mixTaglioProfilo.ToString() /*+ elementivari.lateraleCentrale*/, new Font("thaoma", 7), Brushes.Black, 70, 59);//  laterale
//GFX2.DrawString("laterale pz" + elementivari.numeroLaterali, new Font("thaoma", 7), Brushes.Black, 14, 59);
//GFX2.DrawString("Spostare pressa troncatrice!", new Font("thaoma", 9, FontStyle.Bold), Brushes.Black, 5, 68);
...
//    {
//        GFX2.DrawImage(barcode.Draw(string.Format(barcodeStruct, (mixTaglioTubo - 8).ToString("0000")), 10), PartenzaBarcodeDX, 52);
//        GFX2.DrawString((mixTaglioTubo - 8).ToString(), new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 70, 60);
//        GFX2.DrawString("fond.18", new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 14, 60);
//    }
...
//GFX3.DrawString(elementivari.fermacatena, new Font("thaoma", 8), Brushes.Black, 110, 65);
...
//GFX4.DrawString("R. Mantovana Cat", new Font("thaoma", 8), Brushes.Black, 210, 3);
...
//GFX4.DrawString("COM " + comandiXaffiancate[1], new Font("thaoma", 8), Brushes.Black, 155, 40);
//GFX4.DrawString(Hc, new Font("thaoma", 8), Brushes.Black, 205, 40);
//GFX4.DrawString("(" + mixTeloFinita_Page2 + ")tess", new Font("thaoma", 8), Brushes.Black, 95, 58);
//GFX4.DrawString(elementivari.tipoStaffa, new Font("thaoma", 7, FontStyle.Bold), Brushes.Black, 130, 71);
...
//if (Tessuti.GetTessutoByName(CC[0]).Tessuto_NeD == 2) // se e' tessuto N&D
//{
//    GFX5.DrawImage(barcode.Draw(string.Format(barcodeStruct, (mixTaglioTubo2 - 5).ToString("0000")), 10), PartenzaBarcodeDX, 52);
...
//    if (NoteCMBBX.Text.Contains("tasca")) // con fondale in tasca
//    {
//        GFX5.DrawImage(barcode.Draw(string.Format(barcodeStruct, (mixTaglioTubo2 - 8).ToString("0000")), 10), PartenzaBarcodeDX, 52);
//        GFX5.DrawString((mixTaglioTubo2 - 8).ToString(), new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 70, 60);
//        GFX5.DrawString("fond.18", new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 14, 60);
//    }
...
//    GFX.DrawString("H " + H_TXBX.Text, new Font("thaoma", 8, FontStyle.Bold), Brushes.Black, 105, 40);
//    GFX.DrawString("COM " + ComandiCMBX.Text, new Font("thaoma", 8), Brushes.Black, 150, 40);
//    GFX.DrawString(Hc, new Font("thaoma", 8), Brushes.Black, 205, 40);
//    GFX.DrawString("(" + mixTeloFinita + ")tess " + elementivari.coestruso, new Font("thaoma", 8), Brushes.Black, 95, 58);
//    GFX.DrawString(elementivari.tipoStaffa, new Font("thaoma", 7, FontStyle.Bold), Brushes.Black, 130, 71);
//    GFX.DrawString(Supplemento1CMBX.Text, new Font("thaoma", 8, FontStyle.Bold), Brushes.Black, 5, 70);
...
//    GFX2.Clear(Color.White);
//    GFX2.DrawString(Alias.Substring(0, Alias.Length > 27 ? 27 : Alias.Length), new Font("thaoma", 8), Brushes.Black, 5, 3);
//    GFX2.DrawString(VersioneCMBX.Text, new Font("thaoma", 8), Brushes.Black, 75, 15);
//    // GFX2.DrawString("COM " + ComandiCMBX.Text, new Font("thaoma", 8), Brushes.Black, 200, 4);
//    GFX2.DrawImage(barcode.Draw(string.Format(barcodeStruct, mixTaglioProfiloSuperiore.ToString("0000")), 8), 10, 30);
//    GFX2.DrawString(mixTaglioProfiloSuperiore.ToString(), new Font("thaoma", 7), Brushes.Black, 70, 37);
//    GFX2.DrawString("mantovana", new Font("thaoma", 7), Brushes.Black, 14, 37);
//    GFX2.DrawImage(barcode.Draw(string.Format(barcodeStruct, mixTaglioProfilo.ToString("0000")), 8), 10, 52);
...
//        else
//        {
//            GFX2.DrawString("fondale rettangolare", new Font("thaoma", 7, FontStyle.Bold), Brushes.Black, PartenzaBarcodeDX + 14, 47);
//        }
//    }
...
//    GFX3.DrawString("(" + AttacchiCBX.Text + ")" + "COM " + ComandiCMBX.Text + "-------------------------------------------------------------------------", new Font("thaoma", 8), Brushes.Black, 5, 3);
//    GFX3.DrawString(elementivari.staffaDX, new Font("thaoma", 8), Brushes.Black, 5, 13);
//    GFX3.DrawString(elementivari.staffaSX, new Font("thaoma", 8), Brushes.Black, 5, 22);
