...
{
    public class EtichettaCubo80(Etichetta etichetta) : EtichettaDrawBase(etichetta)
    {
...
//GFX.DrawString("tubo 55", new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 14, 46);
