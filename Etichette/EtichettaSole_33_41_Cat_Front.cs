...
{
    public class EtichettaSole_33_41_Cat_Front
    {
    }
}
...
//GFX2.DrawString("H " + luceHperEtich, new Font("thaoma", 8, FontStyle.Bold), Brushes.Black, 70, 40);
...
//GFX2.DrawString("Pacco F", new Font("thaoma", 12, FontStyle.Bold), Brushes.Black, 123, 58);
...
//GFX2.DrawImage(barcode.Draw(string.Format(barcodeStruct, mixTaglioProfiloInferiore.ToString("0000")), 10), PartenzaBarcodeDX, 46);
//GFX2.DrawString(mixTaglioProfiloInferiore.ToString(), new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 70, 57);
//GFX2.DrawString("P.infer", new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 14, 57);
