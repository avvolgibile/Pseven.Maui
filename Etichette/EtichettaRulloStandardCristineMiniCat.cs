...
{
    public class EtichettaRulloStandardCristineMiniCat(Etichetta etichetta) : EtichettaDrawBase(etichetta)
    {
...
//GFX.DrawString(Nomerullo, new Font("thaoma", 8), Brushes.Black, 215, 0);
...
//GFX.DrawImage(barcode.Draw(string.Format(barcodeStruct, mixTaglioTubo.ToString("0000")), 10), PartenzaBarcodeDX, 22);
...
//if (Supplemento2CMBX.Text.Contains("Guida") && articoliCB.Text.Contains("standard"))
//{
//    if (NoteCMBBX.Text.Contains("tasca")) { MessageBox.Show("Non si puo' avere fond. in tasca quando è impostato con cavetti"); NoteCMBBX.Text = ""; }
//    mixTaglioFondaleManiglia = mixTaglioTubo - 2;
//    GFX.DrawImage(barcode.Draw(string.Format(barcodeStruct, mixTaglioFondaleManiglia.ToString("0000")), 10), PartenzaBarcodeDX, 46);
//    GFX.DrawString(mixTaglioFondaleManiglia.ToString(), new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 70, 56);
//    GFX.DrawString("Fondale", new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 14, 55);
//}
//else
//{
...
//        GFX.DrawImage(barcode.Draw(string.Format(barcodeStruct, (mixTaglioTubo - 8).ToString("0000")), 10), PartenzaBarcodeDX, 46);
//        GFX.DrawString((mixTaglioTubo - 8f).ToString(), new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 70, 56);
//        GFX.DrawString("fond.18", new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 14, 55);
//    }
...
//GFX2.DrawString("- Fermacatena trasparenti", new Font("thaoma", 7), Brushes.Black, 5, 34);
