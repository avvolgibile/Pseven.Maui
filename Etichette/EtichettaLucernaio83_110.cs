...
{
    public class EtichettaLucernaio83_110(Etichetta etichetta) : EtichettaDrawBase(etichetta)
    {
...
//GFX.DrawString(Nomerullo, new Font("thaoma", 8), Brushes.Black, 230, 0);
...
//GFX.DrawString(steccatura[2], new Font("thaoma", 8, FontStyle.Bold), Brushes.Black, 180, 58);
...
//GFX2.DrawString("tuboMotore", new Font("thaoma", 7), Brushes.Black, 14, 34);
...
//GFX2.DrawString("tuboMolla", new Font("thaoma", 7), Brushes.Black, 14, 57);
//GFX2.DrawString("cintino: " + mixBandaFinita + " mm", new Font("thaoma", 7), Brushes.Black, 10, 68);

//GFX2.DrawImage(barcode.Draw(string.Format(barcodeStruct, mixTaglioFondaleManiglia.ToString("0000")), 10), PartenzaBarcodeDX, 3);
//GFX2.DrawString(mixTaglioFondaleManiglia.ToString(), new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 70, 12);
//GFX2.DrawString("fondale", new Font("thaoma", 7), Brushes.Black, PartenzaBarcodeDX + 14, 11);
...
//GFX2.DrawString(steccatura[3], new Font("thaoma", 7), Brushes.Black, 125, 43);
//GFX2.DrawString("stecc. " + steccatura[0], new Font("thaoma", 7), Brushes.Black, 125, 53);
//GFX2.DrawString(steccatura[1], new Font("thaoma", 7), Brushes.Black, 125, 63);
